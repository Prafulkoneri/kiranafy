          ...
          children: [
            Stack(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(top: 130.w, left: 98.w, right: 98.w),
                  child: Image.asset(
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: 24.w, right: 23.w, top: 52.w, bottom: 10.w),
              child: TextField(
...
//<-- SEE HERE
                ...
                Padding(
                  padding: EdgeInsets.only(top: 80.w, left: 25.w),
                  child: Text(
                ...
                Padding(
                  padding: EdgeInsets.only(top: 150.w, left: 24.w, right: 23.w),
                  child: SizedBox(
