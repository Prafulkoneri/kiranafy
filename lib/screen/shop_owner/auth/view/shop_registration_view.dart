            ...
            child: Padding(
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(child:SDropDownField(hint: "Country",)),
                    SizedBox(
                      width: 13.w,
                    ),
                    Expanded(child:SDropDownField(hint: "State",)),
                  ],
                ),
                 SizedBox(
                  height: 18.w,
               ...
               Container(
                ...
                Row(
                  children: [
                    Text("This UPI ID will be used for payment from customers.",style: TextStyle(fontSize: 12.sp,color: Color(0xff3A3A3A),fontWeight: FontWeight.w400),)
                  ],
                ),
                SizedBox(
                  height: 36.w,
