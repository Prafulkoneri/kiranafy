...
class _CustomerDetailViewState extends State<CustomerDetailView> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      context.read<SCustpmerDetailController>().initState(context);
    });
  }

  @override
  Widget build(BuildContext context) {
    final read = context.read<SCustpmerDetailController>();
    final watch = context.watch<SCustpmerDetailController>();
    return Scaffold(
