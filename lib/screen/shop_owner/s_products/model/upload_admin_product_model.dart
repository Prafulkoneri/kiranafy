...
String ? productId;
  ...
  UploadAdminProductReqModel({
   this.productId, this.status,this.mrpPrice,this.offerPrice,this.showUnderFullfillCravings,this.showUnderRecommendedProduct,this.showUnderSeasonalProduct,this.totalRows,this.unitBasedProductImage1,this.unitBasedProductImage2,this.unitBasedProductImage3,this.unitID,this.weight
  });
