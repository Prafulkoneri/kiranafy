          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                 ...
                 watch.orderDetails?.orderStatus!="Delivered"&&watch.shopOrderViewData?.orderRefundStatus==true&& watch.totalRefundAmount !="0"?
                  Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: 17.w),
                    color: Color(0xffEFFDFF),
                  ...
                  ):watch.shopOrderViewData?.orderRefundStatus==true&&watch.orderDetails?.orderStatus=="Delivered" && watch.orderDetails?.shopDeliveredRefundStatus=="NO"?Container(
                   padding: EdgeInsets.symmetric(
                       horizontal: 17.w),
                   color: Color(0xffEFFDFF),
                   child: Column(
                     ...
                     children: [
                       ...
                       Row(
                         ...
                         children: [
                           ...
                           Container(
                             ...
                             child: Center(
                                 child: Text(
                                   watch.orderDetails?.shopDeliveredRefundStatus=="NO"?"Payment Pending":"",
                                   style: TextStyle(
                                       fontSize: 12.sp,
                                       fontWeight:
                                       FontWeight.w500,
                       ...
                       PrimaryButton(
                           color: Color(0xff39C19D),
                           onTap: () {
                             read.shopDeliveredRefundUpdate(context);
                           },
                           text: "Submit Refund Details"),
                       SizedBox(
                         height: 15.w,
                 ...
                 ):watch.shopOrderViewData?.orderRefundStatus==true&&watch.orderDetails?.orderStatus=="Delivered" && watch.orderDetails?.shopDeliveredRefundStatus=="YES"
?Container(
                   padding: EdgeInsets.symmetric(
                       horizontal: 17.w),
                   color: Color(0xffEFFDFF),
                           ...
                           Container(
                             ...
                             child: Center(
                                 child: Text(
                                       ...
                                       watch.orderDetails?.shopDeliveredCustomerPaymentStatus=="not_received"? "Pending from Customer":"Payment Succesful",
                                   style: TextStyle(
                                       fontSize: 12.sp,
                                       fontWeight:
                                       FontWeight
