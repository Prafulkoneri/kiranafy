...
class ShopOrderStatusView extends StatefulWidget {
  ...
  const ShopOrderStatusView({super.key, this.orderId});
...
class _ShopOrderStatusViewState extends State<ShopOrderStatusView> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      context
          .read<ShopOwnerOrderViewController>()
          .initState(context, widget.orderId.toString());
    });
  }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        watch.orderDetails?.orderStatus == "Pending"
                            ...
                            : watch.orderDetails?.orderStatus == "Cofirme"
                                ?
                                ...
                                : watch.orderDetails?.orderStatus == "Deliverd"
                                    ?
                                    ///////////////Deliver Order/////////////
                                    SizedBox(
                                        height: 22.h,
...
///////////////////////CANCLE//////////////////
                ...
                children: [
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Container(
                        padding: EdgeInsets.only(
                            left: 20.w, top: 9.w, bottom: 7.w, right: 34.w),
                  ...
                  //     child: Container(
                  //       padding: EdgeInsets.only(
                  //           left: 20.w, top: 9.w, bottom: 7.w, right: 18.w),
                  //       decoration: BoxDecoration(
                  //           color: SplashText,
                  //           borderRadius: BorderRadius.circular(8)),
                  //       child: Row(
              ...
              //   },
              //   child: Container(
              //     margin: EdgeInsets.only(left: 19.w, right: 20.w),
              //     padding: EdgeInsets.only(
              //         left: 20.w, top: 9.w, bottom: 7.w, right: 67.w),
              //     decoration: BoxDecoration(
              //         color: SplashText,
              //         borderRadius: BorderRadius.circular(8)),
              //     child: Row(
              ...
              Container(
                padding: EdgeInsets.only(left: 19.w, right: 61.w),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
              ...
              Container(
                padding: EdgeInsets.only(left: 19.w, right: 25.w),
                child: Row(
                  // crossAxisAlignment: CrossAxisAlignment.start,/
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
