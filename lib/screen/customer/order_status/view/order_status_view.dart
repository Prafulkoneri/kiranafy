      ...
      body: watch.isLoading?Center(
        ...
        child: Column(
          ...
          children: [
            ...
            //             date: "${watch.trackOrderDetails?.orderPlacedDateAndTime}",
            //             tracker_details: [
            ...
            Row(
              children: [
                ...
                Text("Order Placed",style: TextStyle(fontWeight: FontWeight.w400,color: Black1,fontSize: 14.sp),),
              ],
            ),
           Row(
             crossAxisAlignment: CrossAxisAlignment.start,
             children: [
               ...
               children: [
                 ...
                 Text("We have received your order.",style: TextStyle(
                     color: Black1,
                     fontSize: 12.sp,
                     fontWeight: FontWeight.w400),),
                 SizedBox(
                 ...
                 Text("${watch.trackOrderDetails?.orderPlacedDateAndTime}",style: TextStyle(
                     color: Black1,
                     fontSize: 12.sp,
                     fontWeight: FontWeight.w400),),
               ],)),
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 21.w,
                  decoration: BoxDecoration(
                      color: watch.trackOrderDetails?.orderStatus!="order_placed"?Color(0xff39C19D):Color(0xffC4C4C4),
                      shape: BoxShape.circle
                  ),
                ),
                SizedBox(
                ...
                Text("Order Confirmation",style: TextStyle(fontWeight: FontWeight.w400,color: Black1,fontSize: 14.sp),),
              ],
            ),
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    Text("${watch.trackOrderDetails?.orderConfirmedDateAndTime}",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                  ],)),
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 21.w,
                  decoration: BoxDecoration(
                      color: watch.trackOrderDetails?.orderStatus=="order_placed"||watch.trackOrderDetails?.orderStatus=="order_confirmed"?Color(0xffC4C4C4):Color(0xff39C19D),
                      shape: BoxShape.circle
                  ),
                ),
                SizedBox(
                ...
                Text("Order Packaging",style: TextStyle(fontWeight: FontWeight.w400,color: Black1,fontSize: 14.sp),),
              ],
            ),
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    Text("Your order is been packed",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                    SizedBox(
                    ...
                    Text("${watch.trackOrderDetails?.orderPackingDateAndTime}",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                  ],)),
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 21.w,
                  decoration: BoxDecoration(
                      color:  watch.trackOrderDetails?.orderStatus=="order_dispatched"?Color(0xff39C19D):watch.trackOrderDetails?.orderStatus=="order_delivered"?Color(0xff39C19D):Color(0xffC4C4C4),
                      shape: BoxShape.circle
                  ),
                ),
                SizedBox(
                ...
                Text("Dispatched",style: TextStyle(fontWeight: FontWeight.w400,color: Black1,fontSize: 14.sp),),
              ],
              ...
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    Text("Your order has been dispatched.",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                    SizedBox(
                    ...
                    Text("${watch.trackOrderDetails?.orderDispatchedDateAndTime}",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                  ],)),
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 21.w,
                  decoration: BoxDecoration(
                      color:watch.trackOrderDetails?.orderStatus=="order_delivered"? Color(0xff39C19D):Color(0xffC4C4C4),
                      shape: BoxShape.circle
                  ),
                ),
                SizedBox(
                ...
                Text("Delivered",style: TextStyle(fontWeight: FontWeight.w400,color: Black1,fontSize: 14.sp),),
              ],
            ),
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    Text("We have delivered your package successfully.",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                    SizedBox(
                    ...
                    Text("${watch.trackOrderDetails?.orderDeliveredDateAndTime}",style: TextStyle(
                        color: Black1,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400),),
                  ],)),
