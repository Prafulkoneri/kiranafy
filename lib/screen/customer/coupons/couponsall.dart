          ...
          Expanded(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  ...
                  itemCount:watch.allCouponlistdata?.shopEnquiriesDetails?.length??0,
                  itemBuilder: (BuildContext, index) {
                    final element = watch.allCouponlistdata?.shopEnquiriesDetails?[index];
                    // final element =  watch.shopEnquiriesDetails?[index];
                    return Container(
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () {
                                          ...
                                          showModalBottomSheet(
                                              ...
                                              builder: (context) {
                                                // using a scaffold helps to more easily position the FAB
                                                return CCouponsDetailView(CounponCode: element?.couponCode,
                                                  discountmaxAmount: element?.couponDiscountMaxAmount,
                                                    startDate: element?.couponToDate,
                                                    termCondition: element?.termsCondition,
                                                    disscountPerscentage:element?.couponDiscountMaxAmount ,shopName: element?.shopName);
                                              });
                                        },
                                        child: SvgPicture.asset(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("${element?.couponDiscountPercentage} %OFF",
                                          style: GoogleFonts.dmSans(
                                            textStyle: TextStyle(
                                                color: Black,
                                                letterSpacing: .5,
                                    ...
                                    Text("UPTO ₹${element?.couponDiscountMaxAmount}",
                                        style: GoogleFonts.dmSans(
                                          textStyle: TextStyle(
                                              color: Grey,
                                              letterSpacing: .5,
