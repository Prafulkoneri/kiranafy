        ...
        Container(
          ...
          child:Column(
            ...
            children: [
             Row(
               children: [
                 Text("Set Delivery Address",style: TextStyle(fontSize: 18.sp,fontWeight: FontWeight.w700,color: Color(0xff006F94)),)
               ],
             ),
              Divider(
              ...
              ListView.builder(
               ...
               final element=watch.customerAddress?[index];
                return Column(
                  ...
                  children: [
                   Text(element?.deliveryAddressType??"",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 17.sp,color: Color(0xff040404)),),
                 SizedBox(
                   height: 13.sp,
                 ),
                    Container(
