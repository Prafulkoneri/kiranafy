                        ...
                        ? SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      watch.isCategoryProductAdded[index] ==
                                                                              false
                                                                          ? GestureDetector(
                                                                              onTap: () {
                                                                          ...
                                                                          : GestureDetector(
                                                                              onTap: () {
                                                                                read.removeFromCart(element?.productType, element?.productUnitId, element?.shopId, index, context);
                                                                              },
                                ...
                                //       // physics: NeverScrollableScrollPhysics(),
                                //       shrinkWrap: true,
                                //       itemCount: watch.customProductList?.length ?? 0,
                                //       itemBuilder: (BuildContext, index) {
                                //         final element = watch.customProductList?[index];
                                //         return element?.offerPrice==""&&element?.mrpPrice==""&&element?.productUnitId==null?Container():GestureDetector(
                                //           onTap: () {
                                //             readProductViewController
                                //                 .updateProductId(
                                //               element?.id.toString(),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          children: [
                                                                            Flexible(
                                                                              child: Text(
                                                                                element?.productName ?? "",
                                                                                style: GoogleFonts.dmSans(
                                                                                  textStyle: TextStyle(color: Black1, letterSpacing: .5, fontSize: 16.sp, fontWeight: FontWeight.w700),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                            element?.discountPercentage != ""
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Text("${element?.weight}${element?.unit}",
                                                                                // textAlign: TextAlign.center,
                                                                                style: GoogleFonts.dmSans(
                                                                                  textStyle: TextStyle(color: Grey, letterSpacing: .5, fontSize: 14.sp, fontWeight: FontWeight.w500),
                                                                                )),
                                                                          ],
                                                                        ),
                                                                        Row(
