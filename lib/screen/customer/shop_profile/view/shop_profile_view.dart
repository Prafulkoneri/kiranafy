...
class ShopProfileView extends StatefulWidget {
  ...
  const ShopProfileView({super.key, required this.shopId,required this.routeName,this.categoryId,required this.refreshPage});
...
class _ShopProfileViewState extends State<ShopProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
      watch.isLoading?Center(
        child: CircularProgressIndicator(),
      ):
      WillPopScope(
        onWillPop: () async {
          read.onBackPressed(widget.routeName,context,widget.categoryId);
