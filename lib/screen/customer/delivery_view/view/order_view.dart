...
class _OrderDeliveryViewState extends State<OrderDeliveryView> {
  ...
  Widget build(BuildContext context) {
                                  ...
                                  RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                      color: watch.orderDetails
                                          ...
                                          "Order Refund" &&
                                          watch.orderDetails
                                              ?.customerCancelledStatus == "YES"
                                          ? Colors.red
                                          : watch.orderDetails?.orderStatus ==
                                          "Order Refund" && watch.orderDetails
                                          ?.shopCancelledStatus == "YES"
                                          ? Colors.red
                                          : watch.orderDetails?.orderStatus ==
                                          "Order Refund"
                                          ? Colors.green
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                              "You will save \u{20B9} ${watch.orderDetails
                                  ?.totalDiscount}",
                              //  ",
                              style: GoogleFonts.dmSans(
                                textStyle: TextStyle(
                                ...
                                children: [
                                  ...
                                  watch.orderDetails
                                    ...
                                    style: TextStyle(
                                      ...
                                      ?.refundOrderStatus ==
                                      "accept" ?
                                  int.parse(watch.orderDetails
                                      ?.customerRefundAmount??"0")>int.parse(watch.orderDetails
                                      ?.shopOwnerRefundPayableAmount??"0")?Row(
                                      children: [
                                        Text(
                                          "\u{20B9} ${watch.orderDetails?.customerRefundAmount} ",
                                          style: TextStyle(
                              ...
                              watch.orderDetails
                                ...
                                children: [
                                  ...
                                  watch.orderDetails
                                      ...
                                      ""
                                      ? Text(
                                    "Transaction ID : ${watch.orderDetails
                                        ?.shopOwnerRefundTransactionId}",
                                    style: TextStyle(
                                        fontSize:
                                        14.sp,
    ...
    fontWeight: FontWeight
        .w600,
    fontSize:
    14.sp)):Text("Refund Payment Given by Cash",style:TextStyle(
    fontWeight: FontWeight
        .w600,
    fontSize:
    14.sp)):Container(),
                    ...
                    watch.orderDetails?.shopDeliveredRefundStatus ==
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    "${watch.orderData
                                        ?.orderRefundProductCount} Products",
                                    style: TextStyle(
                                        fontWeight:
                                        FontWeight.w700,
                                        fontSize: 18.sp),
                                  ...
                                  int.parse(watch.orderData
                                      ?.orderRefundAmount.toString()??"0")>int.parse(watch.orderDetails
                                      ?.shopDeliveredPayableAmount.toString()??"0")?
                                  Row(
                                    children: [
                                      Text(
                                        "\u{20B9} ${watch.orderData
                                            ?.orderRefundAmount ?? "0"} ",
                                        style: TextStyle(
                                            fontWeight:
                                            FontWeight.w700,
                              ...
                              watch.orderDetails
                                ...
                                children: [
                                  ...
                                  watch.orderDetails
                                      ?.shopDeliveredTransactionId!=""?Text(
                                    "Transaction ID : ${watch.orderDetails
                          ...
                          watch.orderDetails?.shopDeliveredPayableType=="upi"?Text("Refund Payment Transferred by UPI/QR Code",style:TextStyle(
                              fontWeight: FontWeight
                                  .w600,
                              fontSize:
                              14.sp)):Text("Refund Payment Given by Cash",style:TextStyle(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "INR ${watch.orderData?.orderRefundAmount ??
                                        "0"}",
                                    style: TextStyle(
                                        fontWeight:
                                        FontWeight.w700,
