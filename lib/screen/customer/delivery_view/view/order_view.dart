...
class _OrderDeliveryViewState extends State<OrderDeliveryView> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      final read =
          Provider.of<CustomerOrderViewController>(context, listen: false);
                                                      ...
                                                      : watch.orderDetails
                                                          ...
                                                          : watch.orderDetails
                                                              ...
                                                              ? int.parse(watch
                                                                          ...
                                                                          "0") >
                                                                      int.parse(
                                                                          watch.orderDetails?.shopOwnerRefundPayableAmount ??
                                                                              "0")
                                                                  ? Row(
                                                                      children: [
                                                                        Text(
                                                ...
                                                children: [
                                                  ...
                                                  int.parse(watch.orderData
                                                      ...
                                                      ? Row(
                                                          children: [
                                                            Text(
                                                              "\u{20B9} ${watch.orderData?.orderRefundAmount ?? "0"} ",
                                                              style: TextStyle(
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w700,
                                                            ...
                                                            Text(
                                                              "\u{20B9} ${watch.orderDetails?.shopDeliveredPayableAmount ?? "0"}",
                                                              style: TextStyle(
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w700,
