...
class SecondarySDropDownField extends StatefulWidget {
  ...
  @override
  _SecondarySDropDownFieldState createState() => _SecondarySDropDownFieldState();
}
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField2(
            ...
            isDense: true,
            decoration: InputDecoration(
              suffixIcon: widget.value==null?null:Container(padding: EdgeInsets.only(right: 0.w),child: widget.suffixIcon),
              isDense: true,
              fillColor: Colors.white,
              filled: true,
              contentPadding: EdgeInsets.zero,
            ...
            iconStyleData: IconStyleData(
              icon: Padding(
                padding: widget.iconPadding ?? EdgeInsets.only(right:widget.suffixIcon!=null?0.w: 22.w),
                child: SvgPicture.asset("assets/icons/dropdown.svg"),
              ),
              // iconSize: 30,
            ),
